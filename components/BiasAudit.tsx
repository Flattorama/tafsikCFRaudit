  ...
  return (
    <section className="w-full max-w-7xl mx-auto px-4 py-12 scroll-mt-24" id="audit">
      ...
      <div className="relative group">
        ...
        <div className="md:hidden flex items-center justify-center gap-3 mt-2 mb-4 text-slate-500 animate-pulse">
           <ChevronLeft className="w-4 h-4" />
           <span className="text-[10px] font-mono uppercase tracking-[0.2em] font-bold">Swipe to Browse</span>
