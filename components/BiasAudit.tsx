  ...
  return (
    <section className="w-full max-w-7xl mx-auto px-4 py-12 scroll-mt-24" id="audit">
      ...
      <div className="relative group">
        ...
        {/* Mobile Gradient Overlay - Visual cue for off-screen content */}
        <div className="md:hidden absolute top-0 right-0 bottom-8 w-12 bg-gradient-to-l from-slate-950 to-transparent pointer-events-none rounded-r-lg"></div>
        ...
        {/* Mobile Swipe Indicator (Visual Hint) */}
        <div className="md:hidden flex items-center justify-center gap-3 mt-4 mb-6 animate-pulse">
           <ChevronLeft className="w-4 h-4 text-orange" />
           <span className="text-[10px] font-mono uppercase tracking-[0.2em] font-bold text-slate-300">Swipe to Browse</span>
